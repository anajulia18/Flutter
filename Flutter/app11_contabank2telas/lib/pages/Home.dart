...
class _HomeState extends State<Home> {
  ...
  _obterResultado() {
    setState(() {
      if (nome.text.isNotEmpty && idade.text.isNotEmpty) {
        nomeInf = nome.text;
  ...
  _corpo(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: <Widget>[_corpoFormulario(), _botao(context)],
      ),
    );
  }
  ...
  _campoNome(labelTitulo, objController) {
    return TextField(
      ...
      decoration: InputDecoration(
          ...
          labelStyle: TextStyle(color: Color.fromARGB(255, 10, 255, 1))),
      textAlign: TextAlign.center,
      style: TextStyle(color: Color.fromARGB(255, 81, 255, 0), fontSize: 25.0),
  ...
  _campoIdade(labelTitulo, objController) {
    return TextField(
      ...
      decoration: InputDecoration(
          labelText: labelTitulo,
          labelStyle: TextStyle(color: Color.fromARGB(255, 46, 255, 4))),
      textAlign: TextAlign.center,
      style: TextStyle(color: Color.fromARGB(255, 157, 255, 0), fontSize: 25.0),
      controller: objController,
    );
  }
  ...
  _dropdownSexo() {
    return DropdownButton<String>(
      ...
      style: const TextStyle(
          color: Color.fromARGB(255, 51, 255, 0), fontSize: 25.0),
      underline: Container(
        height: 2,
  ...
  _dropdownEscolaridade() {
    return DropdownButton<String>(
      ...
      elevation: 16,
      style: const TextStyle(
          color: Color.fromARGB(255, 157, 255, 0), fontSize: 25.0),
      underline: Container(
        height: 2,
        color: Colors.deepPurpleAccent,
      ),
  ...
  _switchNacionalidade() {
    return Switch(
      ...
      activeTrackColor: Color.fromARGB(255, 157, 255, 0),
  ...
  _texto(textoParaExibir) {
    return Text(
      ...
      style: TextStyle(color: Color.fromARGB(255, 138, 243, 0), fontSize: 25.0),
    );
  }
  ...
  _textoCentro(textoParaExibir) {
    return Text(
      textoParaExibir,
      textAlign: TextAlign.center,
      style: TextStyle(color: Color.fromARGB(255, 104, 231, 0), fontSize: 25.0),
    );
  }
}
