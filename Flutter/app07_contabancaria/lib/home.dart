...
class _HomeState extends State<Home> {
  ...
  _body() {
    return Container(
      color: Color.fromARGB(255, 95, 0, 63),
  ...
  _text(String text) {
    return Text(
      ...
      style: const TextStyle(
          color: Color.fromARGB(255, 3, 255, 255), fontSize: 22),
    );
  }
  ...
  _subText(String text) {
    return Text(
      text,
      style: const TextStyle(
          color: Color.fromARGB(255, 3, 255, 255), fontSize: 16),
    );
  }
  ...
  _switch(String text) {
    return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      Text(
        text,
        style: const TextStyle(
            color: Color.fromARGB(255, 3, 255, 255), fontSize: 20),
      ),
      Switch(
        value: brazilian,
        onChanged: (value) {
        ...
        activeTrackColor: Color.fromARGB(255, 183, 0, 255),
        activeColor: Color.fromARGB(255, 234, 3, 255),
      )
    ]);
  }
  ...
  _slider(String text) {
    return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      Text(
        text,
        style: const TextStyle(
            color: Color.fromARGB(255, 0, 221, 250), fontSize: 20),
      ),
      Slider(
        value: limit,
  ...
  _field(String labelTitle, TextEditingController objController,
    ...
    return TextField(
      ...
      decoration: InputDecoration(
          ...
          labelStyle: const TextStyle(color: Color.fromARGB(255, 122, 0, 221))),
      textAlign: TextAlign.center,
      style: const TextStyle(
          color: Color.fromARGB(255, 6, 179, 248), fontSize: 25.0),
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          style: ElevatedButton.styleFrom(
              primary: Color.fromARGB(255, 45, 255, 227)),
